...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_Media_Capture_IScreenCapture<D>::SourceSuspensionChanged(Windows::Foundation::TypedEventHandler<Windows::Media::Capture::ScreenCapture, Windows::Media::Capture::SourceSuspensionChangedEventArgs> const& handler) const
    {
        winrt::event_token token;
