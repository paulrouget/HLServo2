...
namespace winrt::impl
{
    template <typename D> auto consume_Windows_Phone_System_Power_IPowerManagerStatics<D>::PowerSavingMode() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Phone::System::Power::IPowerManagerStatics)->get_PowerSavingMode(put_abi(value)));
        return value;
    }
    template <typename D> auto consume_Windows_Phone_System_Power_IPowerManagerStatics<D>::PowerSavingModeChanged(Windows::Foundation::EventHandler<Windows::Foundation::IInspectable> const& changeHandler) const
    {
