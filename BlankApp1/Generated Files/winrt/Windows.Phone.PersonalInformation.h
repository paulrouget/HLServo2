...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_Phone_PersonalInformation_IContactChangeRecord<D>::ChangeType() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Phone::PersonalInformation::IContactChangeRecord)->get_ChangeType(put_abi(value)));
        return value;
    }
    ...
    template <typename D> auto consume_Windows_Phone_PersonalInformation_IContactInformation<D>::SetDisplayPictureAsync(Windows::Storage::Streams::IInputStream const& stream) const
    {
        void* action{};
    ...
    template <typename D> auto consume_Windows_Phone_PersonalInformation_IContactInformation<D>::ToVcardAsync(Windows::Phone::PersonalInformation::VCardFormat const& format) const
    {
        void* operation{};
    ...
    template <typename D> auto consume_Windows_Phone_PersonalInformation_IContactInformation2<D>::DisplayPictureDate(Windows::Foundation::DateTime const& returnValue) const
    {
    ...
    template <typename D> auto consume_Windows_Phone_PersonalInformation_IContactInformationStatics<D>::ParseVcardAsync(Windows::Storage::Streams::IInputStream const& vcard) const
    {
        void* operation{};
    ...
    template <typename D> auto consume_Windows_Phone_PersonalInformation_IContactQueryOptions<D>::OrderBy() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Phone::PersonalInformation::IContactQueryOptions)->get_OrderBy(put_abi(value)));
        return value;
    }
    template <typename D> auto consume_Windows_Phone_PersonalInformation_IContactQueryOptions<D>::OrderBy(Windows::Phone::PersonalInformation::ContactQueryResultOrdering const& value) const
    {
    ...
    template <typename D> auto consume_Windows_Phone_PersonalInformation_IContactStore<D>::CreateContactQuery(Windows::Phone::PersonalInformation::ContactQueryOptions const& options) const
    {
        void* result{};
    ...
    template <typename D> auto consume_Windows_Phone_PersonalInformation_IContactStore<D>::SaveExtendedPropertiesAsync(param::async_map_view<hstring, Windows::Foundation::IInspectable> const& data) const
    {
        void* result{};
    ...
    template <typename D> auto consume_Windows_Phone_PersonalInformation_IContactStoreStatics<D>::CreateOrOpenAsync(Windows::Phone::PersonalInformation::ContactStoreSystemAccessMode const& access, Windows::Phone::PersonalInformation::ContactStoreApplicationAccessMode const& sharing) const
    {
        void* operation{};
    ...
    template <typename D> auto consume_Windows_Phone_PersonalInformation_IStoredContactFactory<D>::CreateStoredContact(Windows::Phone::PersonalInformation::ContactStore const& store) const
    {
        void* result{};
    ...
    template <typename D> auto consume_Windows_Phone_PersonalInformation_IStoredContactFactory<D>::CreateStoredContactFromInformation(Windows::Phone::PersonalInformation::ContactStore const& store, Windows::Phone::PersonalInformation::ContactInformation const& contact) const
    {
        void* result{};
