...
namespace winrt::impl
{
    ...
    struct consume_Windows_Phone_PersonalInformation_IContactInformation
    {
        ...
        auto SetDisplayPictureAsync(Windows::Storage::Streams::IInputStream const& stream) const;
        [[nodiscard]] auto DisplayPicture() const;
        auto GetPropertiesAsync() const;
        auto ToVcardAsync() const;
        auto ToVcardAsync(Windows::Phone::PersonalInformation::VCardFormat const& format) const;
    };
    ...
    struct consume_Windows_Phone_PersonalInformation_IContactInformation2
    {
        ...
        auto DisplayPictureDate(Windows::Foundation::DateTime const& returnValue) const;
    };
    ...
    {
        auto ParseVcardAsync(Windows::Storage::Streams::IInputStream const& vcard) const;
    };
    ...
    struct consume_Windows_Phone_PersonalInformation_IContactQueryOptions
    {
        ...
        auto OrderBy(Windows::Phone::PersonalInformation::ContactQueryResultOrdering const& value) const;
    };
    ...
    struct consume_Windows_Phone_PersonalInformation_IContactStore
    {
        ...
        auto CreateContactQuery(Windows::Phone::PersonalInformation::ContactQueryOptions const& options) const;
        auto DeleteAsync() const;
        [[nodiscard]] auto RevisionNumber() const;
        auto GetChangesAsync(uint64_t baseRevisionNumber) const;
        auto LoadExtendedPropertiesAsync() const;
        auto SaveExtendedPropertiesAsync(param::async_map_view<hstring, Windows::Foundation::IInspectable> const& data) const;
    };
    ...
    struct consume_Windows_Phone_PersonalInformation_IContactStoreStatics
    {
        ...
        auto CreateOrOpenAsync(Windows::Phone::PersonalInformation::ContactStoreSystemAccessMode const& access, Windows::Phone::PersonalInformation::ContactStoreApplicationAccessMode const& sharing) const;
    };
    ...
    {
        auto CreateStoredContact(Windows::Phone::PersonalInformation::ContactStore const& store) const;
        auto CreateStoredContactFromInformation(Windows::Phone::PersonalInformation::ContactStore const& store, Windows::Phone::PersonalInformation::ContactInformation const& contact) const;
    };
