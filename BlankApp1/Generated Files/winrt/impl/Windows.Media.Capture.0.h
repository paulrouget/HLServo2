...
namespace winrt::impl
{
    ...
    struct consume_Windows_Media_Capture_IScreenCapture
    {
        ...
        auto SourceSuspensionChanged(Windows::Foundation::TypedEventHandler<Windows::Media::Capture::ScreenCapture, Windows::Media::Capture::SourceSuspensionChangedEventArgs> const& handler) const;
